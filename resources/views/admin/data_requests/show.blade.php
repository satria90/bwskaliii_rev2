                    ...
                    <fieldset>
                        ...
                        {{-- <div class="mb-3">
                            ...
                            <div id="dropdown1" class="dropdown-content mt-4">
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        <input {{ $dataRequest->UnoperatedPermission ? 'checked' : '' }} disabled  type="checkbox" id="UnoperatedPermission" name="UnoperatedPermission" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                    ...
                                    <div class="flex items-center">
                                        <input {{ $dataRequest->OperatedPermission ? 'checked' : '' }} disabled type="checkbox" id="OperatedPermission" name="OperatedPermission" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                    ...
                                    <div class="flex items-center">
                                        <input {{ $dataRequest->RiverDiversion ? 'checked' : '' }} disabled type="checkbox" id="RiverDiversion" name="RiverDiversion" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="dropdown2" class="dropdown-content mt-4">
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        <input {{ $dataRequest->WaterAvailability ? 'checked' : '' }} disabled type="checkbox" id="WaterAvailability" name="WaterAvailability" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                        <label for="WaterAvailability" class="ml-2 font-poppins text-sm text-slate-700">Ketersediaan Air</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input {{ $dataRequest->MinerC ? 'checked' : '' }} disabled type="checkbox" id="MinerC" name="MinerC" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="dropdown3" class="dropdown-content mt-4">
                                ...
                                <div class="flex flex-wrap gap-4">
                                    ...
                                    <div class="space-y-2 w-1/2">
                                        <div class="flex items-center">
                                            <input {{ $dataRequest->RainFall ? 'checked' : '' }} disabled type="checkbox" id="RainFall" name="RainFall" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                            <label for="RainFall" class="ml-2 font-poppins text-sm text-slate-700">Curah Hujan</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input {{ $dataRequest->WaterHeight ? 'checked' : '' }} disabled type="checkbox" id="WaterHeight" name="WaterHeight" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                            <label for="WaterHeight" class="ml-2 font-poppins text-sm text-slate-700">Tinggi Muka Air</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input {{ $dataRequest->Climatology ? 'checked' : '' }} disabled type="checkbox" id="Climatology" name="Climatology" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                            <label for="Climatology" class="ml-2 font-poppins text-sm text-slate-700">Klimatologi</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input {{ $dataRequest->WaterQuality ? 'checked' : '' }} disabled type="checkbox" id="WaterQuality" name="WaterQuality" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                    ...
                                    <div class="space-y-2 w-1/2">
                                        <div class="flex items-center">
                                            <input {{ $dataRequest->WaterBalance ? 'checked' : '' }} disabled type="checkbox" id="WaterBalance" name="WaterBalance" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                            <label for="WaterBalance" class="ml-2 font-poppins text-sm text-slate-700">Neraca Air</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input {{ $dataRequest->RiverNetwork ? 'checked' : '' }} disabled type="checkbox" id="RiverNetwork" name="RiverNetwork" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                            <label for="RiverNetwork" class="ml-2 font-poppins text-sm text-slate-700">Peta Jaringan Sungai</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input {{ $dataRequest->WaterDischarge ? 'checked' : '' }} disabled type="checkbox" id="WaterDischarge" name="WaterDischarge" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                            <label for="WaterDischarge" class="ml-2 font-poppins text-sm text-slate-700">Debit Sesaat</label>
                                        </div>
                                        <div class="flex items-center">
                                            <input {{ $dataRequest->WatershedMap ? 'checked' : '' }} disabled type="checkbox" id="WatershedMap" name="WatershedMap" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="dropdown4" class="dropdown-content mt-4">
                                    ...
                                    <div class="flex items-center mt-3">
                                        <input {{ $dataRequest->Tools ? 'checked' : '' }} disabled type="checkbox" id="Tools" name="Tools" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                        <label for="Tools" class="ml-2 font-poppins text-sm text-slate-700">Alat</label>
                                    </div>
                                    <div class="flex items-center mt-3">
                                        <input {{ $dataRequest->PumpsEquipment ? 'checked' : '' }} disabled type="checkbox" id="PumpsEquipment" name="PumpsEquipment" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                           ...
                           <!-- Dropdown 5 -->
                            ...
                            <div class="space-y-2 mb-6">
                                <div class="flex items-center">
                                    <input {{ $dataRequest->ForResearch ? 'checked' : '' }} disabled type="checkbox" id="ForResearch" name="ForResearch" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                ...
                                <div class="flex items-center">
                                    <input {{ $dataRequest->ForStudyProject ? 'checked' : '' }} disabled type="checkbox" id="ForStudyProject" name="ForStudyProject" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                    <label for="ForStudyProject" class="ml-2 font-poppins text-sm text-slate-700">Untuk Studi/Kajian/Proyek</label>
                                </div>
            
                                <input value="{{ $dataRequest->otherPurpose }}" disabled type="text" id="otherPurpose" name="otherPurpose" class="mt-1 px-3 py-2 bg-gray-100 border shadow-sm border-slate-200 placeholder-gray-400 focus:outline-none focus:border-gray-300 focus:ring-gray-300 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Lainnya" />
                            </div>
                          
                        <button type="button" onclick="window.location.href='{{ route('admin.data_requests.index') }}'" class="font-bold w-25 h-10 mt-1 px-3 py-2 bg-blue-800 border shadow-sm border-blue-800 block rounded-md sm:text-sm text-white hover:bg-blue-900 hover:text-white">
                            Kembali
                        </button>
                    </fieldset>
                </form>
