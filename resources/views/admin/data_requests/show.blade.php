                ...
                <form method="POST" action="{{ route('admin.data_requests.store') }}" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="space-y-2 mb-6">
                            ...
                            <div class="flex items-center">
                              <input {{ $dataRequest->RiverProfile ? 'checked' : '' }} disabled type="checkbox" id="RiverProfile" name="RiverProfile" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                              <label for="RiverProfile" class="ml-2 font-poppins text-sm text-slate-700">Profil Sungai</label>
                            </div>
                          
                            <div class="flex items-center">
                              <input {{ $dataRequest->Topography ? 'checked' : '' }} disabled type="checkbox" id="Topography" name="Topography" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                              <label for="Topography" class="ml-2 font-poppins text-sm text-slate-700">Topografi</label>
                            </div>

                            <div class="flex items-center">
                                <input {{ $dataRequest->StudyResearch ? 'checked' : '' }} disabled type="checkbox" id="StudyResearch" name="StudyResearch" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                <label for="StudyResearch" class="ml-2 font-poppins text-sm text-slate-700">Studi/Kajian</label>
                            </div>

                            <div class="flex items-center">
                                <input {{ $dataRequest->WaterAllocation ? 'checked' : '' }} disabled type="checkbox" id="WaterAllocation" name="WaterAllocation" value="1" class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                <label for="WaterAllocation" class="ml-2 font-poppins text-sm text-slate-700">Alokasi Air</label>
                            </div>

                            <input value="{{ $dataRequest->otherCheckbox }}" disabled type="text" id="otherCheckbox" name="otherCheckbox" class="mt-1 px-3 py-2 bg-gray-100 border shadow-sm border-slate-200 placeholder-gray-400 focus:outline-none focus:border-gray-300 focus:ring-gray-300 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Informasi Lainnya" />
                        </div>
